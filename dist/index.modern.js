...
function ButtonOverlay(_ref) {
  ...
  })))), showNoti && /*#__PURE__*/React.createElement("div", {
...
function WalletChatWidget(_ref) {
  ...
  var _useState = useState(widgetState === null || widgetState === void 0 ? void 0 : widgetState.isOpen),
      isOpen = _useState[0],
      setIsOpen = _useState[1];

  var _useState2 = useState(widgetState === null || widgetState === void 0 ? void 0 : widgetState.chatAddr),
  ...
  var widget_url = process.env.REACT_APP_APP_URL || "https://app.walletchat.fun";
  useEffect(function () {
    try {
      if (widgetState !== null && widgetState !== void 0 && widgetState.signature) {
        ...
        iframe.contentWindow.postMessage(msg, widget_url);
      } else {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, !hideIframe && /*#__PURE__*/React.createElement("iframe", {
    ...
    src: url.val
  }), /*#__PURE__*/React.createElement(ButtonOverlay, {
    notiVal: numUnread,
...
export { ButtonOverlay, WalletChatWidget };
